package sk.tuke.gamestudio.games.mines.settings;
...
public class Settings implements Serializable {
    ...
    public static final Settings BEGINNER = new Settings(8,8,10);
    public static final Settings INTERMEDIATE = new Settings(16, 16, 40);
    public static final Settings EXPERT = new Settings(25, 25, 99);
    ...
    public boolean equals(Object o){
        ...
        Settings settings = (Settings) o;
            return (((Settings) o).getColumnCount() == columnCount && ((Settings) o).getRowCount() == rowCount
            && ((Settings) o).getMineCount() == mineCount);
    }
